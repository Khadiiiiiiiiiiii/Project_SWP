...
<html lang="en">
    ...
    <body>
        <div class="container mt-5">
            ...
            <hr />
            <form action="updateProduct" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                <!-- Hidden Product ID -->
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-10">
                        <textarea class="form-control ${not empty errors['description'] ? 'is-invalid' : ''}" 
                                  id="description" name="description" required minlength="6" maxlength="500">${product.description}</textarea>
                        <div class="invalid-feedback">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-10">
                        <input type="number" step="0.01" class="form-control ${not empty errors['price'] ? 'is-invalid' : ''}" 
                               id="price" name="price" value="${product.price}" required min="0.01" />
                        <div class="invalid-feedback">
                            ${not empty errors['price'] ? errors['price'] : 'Price must be a positive number.'}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-10">
                        <input type="number" step="0.01" class="form-control ${not empty errors['discountPrice'] ? 'is-invalid' : ''}" 
                               id="discountPrice" name="discountPrice" value="${product.discountPrice}" min="0" max="100" />
                        <div class="invalid-feedback">
                            ${not empty errors['discountPrice'] ? errors['discountPrice'] : 'Discount price must be between 0 and 100.'}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-10">
                        <input type="number" step="1" class="form-control ${not empty errors['stockQuantity'] ? 'is-invalid' : ''}" 
                               id="stockQuantity" name="stockQuantity" value="${product.stockQuantity}" required min="1" max="10000" />
                        <div class="invalid-feedback">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-10">
                        <div class="custom-file-upload">
                            ...
                            <span id="fileName">${product.imageUrl}</span>
                        </div>
                        <input type="file" id="imageFile" name="imageFile" accept="image/*" 
                               class="${not empty errors['imageFile'] ? 'is-invalid' : ''}" style="display: none;" />
                        <div class="invalid-feedback">
                            ${not empty errors['imageFile'] ? errors['imageFile'] : 'Image must be JPG, JPEG, PNG, or GIF (max 10MB).'}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-10">
                        <input type="number" step="1" class="form-control ${not empty errors['promotionId'] ? 'is-invalid' : ''}" 
                               id="promotionId" name="promotionId" value="${product.promotionId}" required min="0" />
                        <div class="invalid-feedback">
        ...
        <script>
            ...
            document.getElementById("imageFile").addEventListener("change", function () {
                let fileName = this.files.length > 0 ? this.files[0].name : "${product.imageUrl}";
